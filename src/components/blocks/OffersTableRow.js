...
export default
    ({fields, onTakeFromThisLP, onOpenLP}) =>
        ...
        style={{
            ...
            <Flex justifyContent="space-between" width="130px" mr="120px">
                <Box width={1/2}><Text size="14px">{fields[1]}</Text></Box>
                <Box width={1/2}><Text size="14px">{fields[2]}</Text></Box>
            </Flex>
            <Flex justifyContent="space-between" width="350px"> 
                ...
                <Box width={1/4}><Text size="14px">{fields[5]}</Text></Box>
                <Box width={1/4}><Text size="14px">{fields[6]}</Text></Box>
            </Flex>
        </Flex>